...
namespace Werewolf_Control.Helpers
{
    ...
    {
        public static string ToBold(this string str) => $"<b>{str.FormatHTML()}</b>";

        public static string ToItalic(this string str) => $"<i>{str.FormatHTML()}</i>";

        public static string FormatHTML(this string str) => str?.Replace("&", "&amp;").Replace("<", "&lt;")
            .Replace(">", "&gt;").Replace("\"", "&quot;");
        ...
        public static string Pad(this int val) => "<code>" + val.ToString().PadRight(5) + "</code>";
        ...
        public static Player GetBasePlayer(this Message m, WWContext db) =>
            db.Players.FirstOrDefault(x => x.TelegramId == m.From.Id);
