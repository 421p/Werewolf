    ...
    var c = e.cookie = function(p, o, u) {
        if (o !== undefined) {
            ...
            return(document.cookie = [
                encodeURIComponent(p), "=", c.raw ? o : encodeURIComponent(o),
                u.expires ? "; expires=" + u.expires.toUTCString() : "", u.path ? "; path=" + u.path : "",
                u.domain ? "; domain=" + u.domain : "", u.secure ? "; secure" : ""
            ].join(""))
        }
        var g = c.raw ? d : b;
...
jQuery(document).ready(function() {
    ...
    // ADD CLASS
    jQuery("head")
        .append('<link href="assets/plugins/styleswitcher/styleswitcher.css" rel="stylesheet" type="text/css" />');
    ...
    jQuery("#hideSwitcher, #showSwitcher").click(function() {
        ...
        jQuery(_identifier).animate({ "margin-left": "-500px" },
            500,
            function() {
                jQuery(this).hide();
            });
    ...
    **/
    jQuery("input.dark_switch").bind("click",
        function() {
    ...
    /**
        RTL|LTR
    **/
    jQuery("input.rtl_switch").bind("click",
        function() {
            ...
            if (_direction == 'rtl') {
                ...
                jQuery("head")
                    .append('<link href="assets/css/layout-RTL.css" rel="stylesheet" type="text/css" id="rtl_ltr" />');
    ...
    **/
    jQuery("input.boxed_switch").bind("click",
        function() {
