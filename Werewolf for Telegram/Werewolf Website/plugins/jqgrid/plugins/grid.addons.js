            ...
            return this.each(function() {
                ...
                if ($.fn.searchFilter) {
                    ...
                    if ($("#" + fid).html() != null) {
                        ...
                        $.each(colModel,
                            function(i, v) {
                                var searchable = (typeof v.search === 'undefined') ? true : v.search,
                                    ...
                                    soptions = $.extend({},
                                        { text: colNames[i], itemval: v.index || v.name },
                                        this.searchoptions),
                        ...
                        if (fields.length > 0) {
                            $("<div id='" + fid + "' role='dialog' tabindex='-1'></div>")
                            ...
                            if (p.drag === true) {
                                ...
                                if (jQuery.fn.jqDrag) {
                                    ...
                                    try {
                                        $("#" + fid).draggable({
                                            handle: $("#" + fid + " table thead tr:first td:first")
                                        });
                                    } catch (e) {
                                    }
                                }
            ...
            return this.each(function() {
                ...
                var formFill = function() {
                    ...
                    $.each(self.p.filterModel,
                        function(i, n) {
                            ...
                            case 'text':
                                ...
                                $(td).append("<input type='text' name='" +
                                    (this.index || this.name) +
                                    "' id='sg_" +
                                    this.name +
                                    "' value='" +
                    ...
                    if (self.p.enableSearch === true) {
                        sb = "<input type='button' id='sButton' class='" +
                            self.p.buttonclass +
                            "' value='" +
                            self.p.searchButton +
                            "'/>";
                    ...
                    if (self.p.enableClear === true) {
                        cb = "<input type='button' id='cButton' class='" +
                            self.p.buttonclass +
                            "' value='" +
                            self.p.clearButton +
                            "'/>";
