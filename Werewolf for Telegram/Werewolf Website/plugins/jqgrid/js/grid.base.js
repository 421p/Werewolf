        ...
        return this.each(function() {
                    ...
                    populateVisible: function() {
                        ...
                        if (tbot < dh &&
                            ...
                            (p.lastpage === undefined ||
                                (parseInt((tbot + scrollTop + div - 1) / div, 10) || 0) <= p.lastpage)) {
            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                normalizeData = function() {
                    var p = ts.p,
                        ...
                        iOffset = (p.multiselect === true ? 1 : 0) +
                            (p.subGrid === true ? 1 : 0) +
                    ...
                    if (ts.p.rowList.length > 0) {
                        ...
                        for (i = 0; i < ts.p.rowList.length; i++) {
                            ...
                            str += "<option role=\"option\" value=\"" +
                                strnm[0] +
                                "\"" +
                                ((intNum(ts.p.rowNum, 0) === intNum(strnm[0], 0)) ? " selected=\"selected\"" : "") +
                                ">" +
                                strnm[1] +
                                "</option>";
                        }
            ...
            var arf = ts.p.hidegrid === true
                ? $("<a role='link' class='ui-jqgrid-titlebar-close ui-corner-all HeaderButton' " +
                    (ts.p.showhide ? "title='" + ts.p.showhide + "'" : "") +
                    " />").hover(
                ...
                if (!$t.p.multiselect) {
                    if (pt.className !== "ui-subgrid") {
                        if ($t.p.selrow !== pt.id) {
                            ...
                            if (csr) {
                                $(csr).removeClass("ui-state-highlight")
