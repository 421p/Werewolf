                        ...
                        for (i = 0; i < arrln; i++) {
                            if (value == null) {
                                ...
                                try {
                                    label = (arrln === 1
                                        ? mainval + vl
                                        : mainval + vl + "_" + aggr[i].aggregator + "_" + String(i));
                                } catch (e) {
                                }
                            }
                                    ...
                                    if (lastval[items.level] !== items.text &&
                                        ...
                                        if (items.level > 0) {
                                            ...
                                            if (items.level - 1 === (o.rowTotals ? 1 : 0)) {
                                                if (collen > 0) {
                                                    var l1 = headers[items.level - 1].groupHeaders[collen - 1]
                                                        .numberOfColumns;
                                                    if (l1) {
                                            ...
                                            headers[items.level - 1].groupHeaders[collen].startColumnName =
                                                columns[colpos].name;
                                            headers[items.level - 1].groupHeaders[collen].numberOfColumns =
