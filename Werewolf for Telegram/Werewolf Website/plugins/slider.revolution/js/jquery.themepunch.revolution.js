...
(function(jQuery, undefined) {
    ...
    jQuery.fn.extend({
        ...
        revolution: function(options) {
            ...
            var defaults = {
                ...
                navigationStyle:
                    "round", // round,square,navbar,round-old,square-old,navbar-old, or any from the list in the docu (choose between 50+ different item),
    ...
    *******************************************/
    ...
    function initSlider(container, opt) {
        ...
        if (opt.navigationStyle == "preview1" ||
        ...
        if (opt.forceFullWidth == "on" && container.closest('.forcefullwidth_wrapper_tp_banner').length == 0) {
            ...
            container.parent().wrap('<div style="position:relative;width:100%;height:auto;margin-top:' +
                mt +
                ';margin-bottom:' +
                mb +
        ...
        if (!container.hasClass("revslider-initialised")) {
            ...
            ********************************/
            ...
            jQuery(window).on('mozfullscreenchange webkitfullscreenchange fullscreenchange',
                function() {
            ...
            container.find('.tp-scrollbelowslider').on('click',
                function() {
                    var off = 0;
                    try {
...
********************************/
    ...
    ********************************/
    ...
    var createBullets = function(container, opt) {
        ...
        if (opt.navigationType == "bullet" || opt.navigationType == "both") {
            container.parent().append('<div class="tp-bullets ' +
                starthidebullets +
                ' simplebullets ' +
                opt.navigationStyle +
                '"></div>');
    ...
    var createArrows = function(container, opt) {
        ...
        function aArrow(dir) {
            container.parent().append('<div style="' +
                hidden +
                '" class="tp-' +
                dir +
                'arrow ' +
    ...
    *******************************************************/
    ...
    var setSize = function(img, opt) {
        ...
        opt.container.closest('.forcefullwidth_wrapper_tp_banner').find('.tp-fullwidth-forcer')
    ...
    var prepareSlides = function(container, opt) {
        ...
        container.find('>ul:first >li >img').each(function(j) {
            ...
            if (isIE(8)) {
                ...
                pari.find('.tp-bgimg').append('<img class="ieeightfallbackimage defaultimg" src="' +
                    src +
                    '" style="width:100%">');
            }
            ...
            if (vorh == "horizontal") {
                ...
                for (var i = 0; i < opt.slots; i++) {
                    ...
                    if (scalestart != undefined && rotatestart != undefined)
                        punchgs.TweenLite.set(sh.find('.slot').last(), { rotationZ: rotatestart });
                    if (isIE(8)) {
                        sh.find('.slot ').last().find('.slotslide').append('<img class="ieeightfallbackimage" src="' +
                            imgsrc +
                                                    ...
                                                    player = new YT.Player(frameID,
                                                        {
                                                            events: {
                                                                ...
                                                                'onReady': function(event) {
                                                                    ...
                                                                    // PLAY VIDEO IF THUMBNAIL HAS BEEN CLICKED
                                                                    nextcaption.find('.tp-thumb-image').click(
                                                                        function() {
                                                                            punchgs.TweenLite.to(jQuery(this),
                                                                                0.3,
                                                                                {
                                        ...
                                        if (!html5vid.hasClass("HasListener")) {
                                            ...
                                            if (nextcaption.data('dottedoverlay') != "none" &&
                                                ...
                                                if (nextcaption.find('.tp-dottedoverlay').length != 1)
                                                    html5vid.append('<div class="tp-dottedoverlay ' +
                                            ...
                                            if (jvideo.attr('control') == undefined) {
                                                ...
                                                html5vid.find('video, .tp-poster, .tp-video-play-button').click(
                                                    function() {
    ...
    var callCaptionLoops = function(nextcaption, factor) {
        ...
        nextcaption.find('.rs-pendulum').each(function() {
            ...
            if (el.data('timeline') == undefined) {
                ...
                el.data('timeline').append(new punchgs.TweenLite.fromTo(el,
                    speed,
        ...
        nextcaption.find('.rs-wave').each(function() {
            ...
            if (el.data('timeline') == undefined) {
                ...
                el.data('timeline').append(new punchgs.TweenLite.fromTo(angobj,
                    speed,
                    { a: 360 },
                    {
                        a: 0,
