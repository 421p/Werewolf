    ...
    flash: [
        {
            ...
            types: [
                ...
                'video/dailymotion', 'video/x-dailymotion', 'application/x-mpegURL'
            ]
        }
...
mejs.HtmlMediaElementShim = {
    ...
    createPlugin: function(playback, options, poster, autoplay, preload, controls) {
        ...
        case 'vimeo':
            ...
            container.innerHTML = '<iframe src="//player.vimeo.com/video/' +
            ...
            },
            {
                ...
                action: function(player, media) {
                    if (!isNaN(media.duration) && media.duration > 0) {
                        ...
                        // 5%
                        var newTime = Math.max(media.currentTime - player.options.defaultSeekBackwardInterval(media),
                            0);
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        hideControls: function(doAnimation) {
            ...
            if (doAnimation) {
                ...
                // any additional controls people might add and want to hide
                t.container.find('.mejs-control').stop(true, true).fadeOut(200,
                    function() {
                        $(this)
                            .css('visibility', 'hidden')
                            .css('display', 'block');
            ...
            var
                ...
                bigPlay =
                    $('<div class="mejs-overlay mejs-layer mejs-overlay-play">' +
                        ...
                        .appendTo(layers)
                        .bind('click',
                            function() { // Removed 'touchstart' due issues on Samsung Android devices where a tap on bigPlay started and immediately stopped the video
                                if (t.options.clickToPlayPause) {
                                    if (media.paused) {
                                        media.play();
                                    }
            ...
            */
            ...
            media.addEventListener('canplay',
                function() {
                    ...
                    controls.find('.mejs-time-buffering').hide();
                    clearTimeout(media
                        .canplayTimeout); // Clear timeout inside 'loadeddata' to prevent 'canplay' to fire twice
                },
                false);
            ...
            media.addEventListener('keydown',
                function(e) {
                    ...
                    .bind('mousedown touchstart',
                        function(e) {
                            ...
                            if (e.which === 1 || e.which === 0) {
                                mouseIsDown = true;
                                handleMouseMove(e);
                                t.globalBind('mousemove.dur touchmove.dur',
                                    function(e) {
                                        handleMouseMove(e);
                                    });
    ...
    $.extend(MediaElementPlayer.prototype,
        {
            ...
            updateDuration: function() {
                ...
                if (t.durationD && (t.options.duration > 0 || t.media.duration)) {
                    t.durationD.html(
                        mejs.Utility.secondsToTimeCode(t.options.duration > 0 ? t.options.duration : t.media.duration,
                            t.options));
                }
            }
        });
                ...
                var t = this,
                    ...
                    positionVolumeHandle = function(volume, secondTry) {
                        ...
                        if (volume === 0) {
                            ...
                            mute.children('button').attr('title', mejs.i18n.t('Unmute'))
                                .attr('aria-label', mejs.i18n.t('Unmute'));
                        } else {
                            mute.removeClass('mejs-unmute').addClass('mejs-mute');
                            mute.children('button').attr('title', mejs.i18n.t('Mute'))
                        ...
                        if (t.isInIframe) {
                            ...
                            setTimeout(function checkFullscreen() {
                                    ...
                                    if (t.isNativeFullScreen) {
                                        ...
                                        if (Math.abs(screenWidth - windowWidth) >
                                            Math.abs(screenWidth - zoomedWindowWidth)) {
    ...
    $.extend(MediaElementPlayer.prototype,
        {
            ...
            buildtracks: function(player, controls, layers, media) {
                ...
                if (t.options.toggleCaptionsButtonWhenOnlyOne && subtitleCount == 1) {
                    ...
                    player.captionsButton.on('mouseenter focusin',
                            function() {
                ...
                if (typeof postrollLink !== 'undefined') {
                    player.postroll =
                        $(
                            ...
                            '</a><div class="mejs-postroll-layer-content"></div></div>').prependTo(layers).hide();
