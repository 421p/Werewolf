...
//////////////////////////////////////////
        ...
        if (as)
            jQuery.each(as,
                function(i, a) {
                    ...
                    var tnc = a.layer == "backgroundvideo"
                    ...
                    if (jQuery.inArray(a.action,
                            ["toggleslider", "toggle_mute_video", "toggle_global_mute_video", "togglefullscreen"]) !=
                        -1) {
                            ...
                            if (a.action == "stoplayer" || a.action == "togglelayer" || a.action == "startlayer") {
                                if (tnc.length > 0)
                                    if (a.action == "startlayer" ||
                                        ...
                                        punchgs.TweenLite.delayedCall(a.delay,
                                            function() {
                                                tl.play(0);
                                            },
                                            [tl]);
                                    } else if (a.action == "stoplayer" ||
                                        (a.action == "togglelayer" && tnc.data('animdirection') != "out")) {
    ...
    var actionSwitches = function(tnc, opt, a, _nc) {
        ...
        case "scrollbelow":
            ...
            off = off - aof || 0;
            jQuery('body,html').animate({ scrollTop: (opt.c.offset().top + (jQuery(opt.li[0]).height()) - off) + "px" },
                { duration: 400 });
            break;
        case "callback":
            eval(a.callback);
        ...
        case "togglefullscreen":
            ...
            } else if (jQuery('#rs-go-fullscreen').length == 0 &&
