        ...
        _R,
        {
            ...
            resetVideo: function(_nc, opt) {
                ...
                case "youtube":
                    ...
                    if (_nc.find('.tp-videoposter').length == 0)
                        punchgs.TweenLite.to(_nc.find('iframe'),
                            0.3,
                            { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
                    break;
            ...
            checkVideoApis: function(_nc, opt, addedApis) {
                ...
                if ((_nc.data('ytid') != undefined ||
                    _nc.find('iframe').length > 0 && _nc.find('iframe').attr('src').toLowerCase().indexOf('youtube') > 0
            ...
            manageVideoLayer: function(_nc, opt, recalled, internrecalled) {
                ...
                var vida = _nc.data("videoattributes"),
                    ...
                    httpprefix = "http",
                    videoloop = _nc.data('videoloop') == "loop"
                        ? "loop"
                        : _nc.data('videoloop') == "loopandnoslidestop"
                        ? "loop"
                        : "",
                    videotype = (videomp != undefined || videowebm != undefined)
                        ? "html5"
                    ...
                    newvideotype = (videotype == "html5" && _nc.find(tag).length == 0)
                        ? "html5"
                ...
                case "html5":
                    ...
                    if (videowebm != undefined && _R.get_browser().toLowerCase() == "firefox")
                    ...
                    if (_nc.find('iframe').length == 0)
                        _nc.find('.tp-videoposter').click(function() {
                            ...
                            if (_ISM) {
                                ...
                                punchgs.TweenLite.to(_nc.find('.tp-videoposter'),
                                    0.3,
                ...
                if (_nc.data('dottedoverlay') != "none" &&
                        ...
                        events: {
                            "onStateChange": function(event) {
                                ...
                                if (event.data == YT.PlayerState.PLAYING) {
                                    ...
                                    opt.c.trigger('revolution.slide.onvideoplay',
                                    ...
                                    if (!fsmode &&
                                        ...
                                        punchgs.TweenLite.to(_nc.find('.tp-videoposter'),
                                            0.3,
                                            { autoAlpha: 1, force3D: "auto", ease: punchgs.Power3.easeInOut });
                                        punchgs.TweenLite.to(_nc.find('iframe'),
                                            0.3,
                                            { autoAlpha: 0, ease: punchgs.Power3.easeInOut });
                                    }
                                    if ((event.data != -1 && event.data != 3)) {
                                        ...
                                        opt.c.trigger('revolution.slide.onvideostop',
                                            getVideoDatas(player, "youtube", _nc.data()));

                                        if (opt.currentLayerVideoIsPlaying == undefined ||
        ...
        addEvent(video,
            ...
            function() {
                ...
                punchgs.TweenLite.to(_nc.find('.tp-videoposter'),
                    0.3,
                    { autoAlpha: 0, force3D: "auto", ease: punchgs.Power3.easeInOut });
                punchgs.TweenLite.to(_nc.find(tag),
                    0.3,
                    { autoAlpha: 1, display: "block", ease: punchgs.Power3.easeInOut });
