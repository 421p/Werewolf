            ...
            checkForParallax: function(container, opt) {
                ...
                function setDDDInContainer(li) {
                    if (_.type == "3D" || _.type == "3d") {
                        ...
                        li.find('.rs-parallaxlevel-tobggroup').closest('.tp-parallax-wrap').wrapAll(
                        ...
                        punchgs.TweenLite.set(li,
                            { overflow: "visible", transformStyle: "preserve-3d", perspective: 1600 });
                ...
                opt.c.find('.tp-revslider-slidesli .slotholder, .tp-revslider-slidesli .rs-background-video-layer')
                    .each(function() {
                        var t = jQuery(this),
                ...
                if (_.type == "mouse" ||
                    ...
                    container.on('mousemove.hoverdir, mouseleave.hoverdir, trigger3dpath',
                        function(event, data) {
            ...
            scrollTicker: function(opt, container) {
                ...
                if (opt.scrollTicker != true) {
                    ...
                    if (_ISM) {
                        ...
                        punchgs.TweenLite.ticker.addEventListener("tick",
                            function() { _R.scrollHandling(opt); },
                            container,
                            false,
                            1);
                    } else {
