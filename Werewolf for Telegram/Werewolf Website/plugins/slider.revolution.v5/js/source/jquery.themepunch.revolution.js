    ...
    jQuery.fn.extend({
        revolution: function(options) {
            ...
            var defaults = {
                delay: 9000,
                responsiveLevels:
                    4064, // Single or Array for Responsive Levels i.e.: 4064 or i.e. [2048, 1024, 768, 480]					
                visibilityLevels:
                [
                    2048, 1024, 778, 480
                ...
                hideCaptionAtLimit:
                    0, // It Defines if a caption should be shown under a Screen Resolution ( Basod on The Width of Browser)
                hideAllCaptionAtLimit: 0, // Hide all The Captions if Width of Browser is less then this value
                hideSliderAtLimit:
                    0, // Hide the whole slider, and stop also functions if Width of Browser is less than this value										
            ...
            return this.each(function() {
                ...
                if (options.navigation != undefined && options.navigation.touch != undefined)
                    options.navigation.touch.swipe_min_touches = options.navigation.touch.swipe_min_touches > 5
                        ? 1
                        : options.navigation.touch.swipe_min_touches;


                jQuery(this).on("scriptsloaded",
                    function() {
        ...
        revscroll: function(oy) {
            return this.each(function() {
                ...
                if (container != undefined &&
                    ...
                    jQuery('body').find('#' + container.attr('id')).length > 0)
                    jQuery('body,html')
                        .animate({ scrollTop: (container.offset().top + (container.height()) - oy) + "px" },
                            { duration: 400 });
            })
        },
    ...
    jQuery.extend(true,
        _R,
        {
            ...
            callingNewSlide: function(opt, container, direction) {
                ...
                var aindex = container.find('.next-revslide').length > 0
            ...
            setSize: function(opt) {
                ...
                if (opt.height > opt.gridheight[opt.curWinRange] && opt.autoHeight != "on")
                            ...
                            if (offcontainers)
                                jQuery.each(offcontainers,
                                    function(index, searchedcont) {
                                        coh = jQuery(searchedcont).length > 0
            ...
            enterInViewPort: function(opt) {
                ...
                if (opt.lastplayedvideos != undefined && opt.lastplayedvideos.length > 0) {
                    ...
                    jQuery.each(opt.lastplayedvideos,
                        function(i, _nc) {
    ...
    var getNeededScripts = function(o, c) {
        ...
        if (!c.data('version') || !c.data('version').toString().match(/5./gi)) {
            ...
            c.find('.tp-caption, .tp-static-layer, .rs-background-video-layer').each(function() {
                var _nc = jQuery(this);
                if ((_nc.data('ytid') != undefined ||
                    _nc.find('iframe').length > 0 &&
                    _nc.find('iframe').attr('src').toLowerCase().indexOf('youtube') > 0))
                    n.videos = true;
                if ((_nc.data('vimeoid') != undefined ||
                    _nc.find('iframe').length > 0 && _nc.find('iframe').attr('src').toLowerCase().indexOf('vimeo') > 0))
                    n.videos = true;
    ...
    var runSlider = function(container, opt) {
        ...
        jQuery.each(opt.allli,
            function(index, li) {
                ...
                obj.src = li.data('thumb') !== undefined
                    ? li.data('thumb')
                    : img.data('lazyload') !== undefined
                    ? img.data('lazyload')
                    : img.attr('src');
                if (li.data('title') !== undefined)
                    obj.params.push({ from: RegExp("\\{\\{title\\}\\}", "g"), to: li.data("title") })
                if (li.data('description') !== undefined)
                    obj.params.push({ from: RegExp("\\{\\{description\\}\\}", "g"), to: li.data("description") })
                for (var i = 1; i <= 10; i++) {
                ...
                if (li.data('link') != undefined) {
                    ...
                    var apptxt =
                        ...
                        jts = linktoslide === "scroll_under"
                            ...
                            : '[{"event":"click","action":"jumptoslide","slide":"' + linktoslide + '","delay":"0.2"}]'

                    apptxt = linktoslide == "no"
                        ? apptxt + ' data-start="0">'
        ...
        if (opt.sliderLayout != "auto" && container.closest('.forcefullwidth_wrapper_tp_banner').length == 0) {
            if (opt.sliderLayout !== "fullscreen" || opt.fullScreenAutoWidth != "on") {
                ...
                cp.wrap('<div class="forcefullwidth_wrapper_tp_banner" id="' +
                    cid +
                ...
                container.closest('.forcefullwidth_wrapper_tp_banner').append(
                    '<div class="tp-fullwidth-forcer" style="width:100%;height:' + container.height() + 'px"></div>');
        ...
        if (!container.hasClass("revslider-initialised")) {
            ...
            container.find('.tp-caption, .rs-background-video-layer').each(function(i) {
                ...
                var pom = _nc.data('noposteronmobile') ||
                ...
                if (_nc.hasClass("tp-caption")) {
                    ...
                    _nc.wrap('<div class="tp-parallax-wrap" style="' +
                        ec +
            ...
            container[0].addEventListener('mouseenter',
                function() {
            ...
            waitForCurrentImages(container.find('.tp-static-layers'),
                opt,
                function() {
            ...
            opt.allli.each(function(i) {
                ...
                if (opt.lazyType == "all" ||
                (opt.lazyType == "smart" &&
                    (i == 0 || i == 1 || i == opt.slideamount || i == opt.slideamount - 1))) {
                    loadImages(li, opt, i);
                    waitForCurrentImages(li,
                        opt,
                        function() {
            ...
            ********************************/
            ...
            jQuery(window).on(resizid,
                function() {
                    ...
                    if (opt.sliderLayout == "fullscreen") {
                        ...
                        if ((opt.fallbacks.ignoreHeightChanges == "mobile" && _ISM) ||
                            opt.fallbacks.ignoreHeightChanges == "always") {
                            opt.fallbacks.ignoreHeightChangesSize = opt.fallbacks.ignoreHeightChangesSize == undefined
                                ? 0
                                : opt.fallbacks.ignoreHeightChangesSize;
                            hchange = (jwh != opt.lastwindowheight) &&
                                (Math.abs(jwh - opt.lastwindowheight) > opt.fallbacks.ignoreHeightChangesSize)
                        } else {
                            hchange = (jwh != opt.lastwindowheight)
                        }
                    }
            ...
            if (!opt.fallbacks.disableFocusListener &&
                ...
                opt.fallbacks.disableFocusListener !== true) tabBlurringCheck(container, opt);
        }
    }
                ...
                opt.c.on('tp-mouseenter',
                    function() {
                        if (opt.layersonhover)
                            jQuery.each(opt.layersonhover,
                                function(i, tnc) {
                                    tnc.data('animdirection', "in");
                                    var otl = tnc.data('timeline_out'),
                                        base_offsetx = opt.sliderType === "carousel"
                                            ? 0
                                    ...
                                    if ((cli.length > 0 && (cli.hasClass("active-revslide")) ||
    ...
    var contWidthManager = function(opt) {
        ...
        if (opt.sliderLayout != "auto" && (opt.sliderLayout !== "fullscreen" || opt.fullScreenAutoWidth != "on")) {
            ...
            punchgs.TweenLite.set(opt.c.parent(),
                { 'left': (0 - loff) + "px", 'width': jQuery(window).width() - _R.getHorizontalOffset(opt.c, "both") });
        } else {
            if (opt.sliderLayout == "fullscreen" && opt.fullScreenAutoWidth == "on")
                punchgs.TweenLite.set(opt.ul, { left: 0, width: opt.c.width() });
            else
                punchgs.TweenLite.set(opt.ul,
                    { left: rl, width: opt.c.width() - _R.getHorizontalOffset(opt.c, "both") });
        }
...
///////////////////////////////////////
    var prepareSlides = function(container, opt) {
        ...
        opt.allli.each(function(j) {
            ...
            if ((opt.startWithSlide != undefined && originalIndex == opt.startWithSlide) ||
        ...
        opt.allli.find('>img').each(function(j) {
            ...
            img.parent().append('<div class="tp-bgimg defaultimg" style="background-color:' +
            ...
            var comment =
                document.createComment("Runtime Modification - Img tag is Still Available for SEO Goals in Source - " +
                    img.get(0).outerHTML);
    ...
    var loadImages = function(container, opt, prio, staticlayer) {
        ...
        container.find('img,.defaultimg, .tp-svg-layer').each(function() {
            var element = jQuery(this),
                src = element.data('lazyload') !== undefined && element.data('lazyload') !== "undefined"
...
// WAIT PROGRESS TILL THE PREDEFINED CONTAINER HAS ALL IMAGES LOADED INSIDE
    var waitForCurrentImages = function(nextli, opt, callback) {
        ...
        nextli.find('img,.defaultimg, .tp-svg-layer').each(function() {
            var element = jQuery(this),
                src = element.data('lazyload') != undefined
                    ? element.data('lazyload')
                    : element.data('svg_src') != undefined
                    ? element.data('svg_src')
                    : element.attr('src'),
            ...
            if (element.data('loaded') === undefined &&
                loadobj !== undefined &&
                loadobj.progress &&
        ...
        container.on('tp-mouseleft',
            function() {
                ...
                if (container.data('conthover') != 1 &&
                    ...
                    ((opt.viewPort.enable == true && opt.inviewport) || opt.viewPort.enable == false)) {
...
// 	-	BLUR / FOXUS FUNCTIONS ON BROWSER 
    ...
    var restartOnFocus = function(opt) {
        ...
        if (opt.windowfocused != true) {
            ...
            punchgs.TweenLite.delayedCall(0.3,
                function() {
