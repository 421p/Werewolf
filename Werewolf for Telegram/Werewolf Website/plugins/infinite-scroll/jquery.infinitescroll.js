...
(function(factory) {
    ...
    $.infinitescroll.defaults = {
        ...
        path:
            undefined, // Either parts of a URL as an array (e.g. ["/page/", "/"] or a function that takes in the page number and returns a URL
        prefill:
            false, // When the document is smaller than the window, load data until the document is larger or links are exhausted
        maxPage:
            undefined // to manually control maximum page (when maxPage is undefined, maximum page limitation is not work)
    };
    ...
    $.infinitescroll.prototype = {
        ...
        _prefill: function infscr_prefill() {
            ...
            this._prefill = function() {
                ...
                $window.bind('resize.infinite-scroll',
                    function() {
                        if (needsPrefill()) {
        ...
        _showdonemsg: function infscr_showdonemsg() {
            ...
            opts.loading.msg
                ...
                .hide()
                .parent()
                .find('div').html(opts.loading.finishedMsg).animate({ opacity: 1 },
                    2000,
                    function() {
