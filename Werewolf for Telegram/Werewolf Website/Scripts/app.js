...
function Init(e) {
    _owl_carousel(), _popover(), _lightbox(), _scrollTo(), _toggle(), _placeholder(), _charts(e), _slimScroll(),
        _autosuggest(), _form(), _select2(), _stepper(), _pickers(), _editors(), _misc(), _afterResize(e), _panels(),
        _modalAutoLoad(), _toastr(!1, !1, !1, !1), _ajaxPage(e), jQuery("[data-toggle=tooltip]").tooltip(),
...
function _afterResize() {
    jQuery(window).load(function() {
        ...
        jQuery(window).resize(function() {
            window.afterResizeApp && clearTimeout(window.afterResizeApp), window.afterResizeApp = setTimeout(
                function() {
                    window.width =
                            jQuery(window).width(), window.width > 768
                            ? jQuery("#mobileMenuBtn").removeClass("active")
                            : (jQuery("#mobileMenuBtn").removeClass("active"), jQuery("body").removeClass("menu-open")),
                        _asideFix()
                },
                300)
        })
        ...
        jQuery("a").bind("click",
            function(e) {
                if (jQuery(this).hasClass("external") ||
                    ...
                    "javascript:;" == jQuery(this).attr("href") ||
                    "javascript:void(0);" == jQuery(this).attr("href") ||
                    "javascript:void(0)" == jQuery(this).attr("href")) e.preventDefault(), e.stopPropagation();
                else {
                    e.preventDefault();
                    var t = jQuery(this).attr("href"),
                        t = t.replace("#", "");
...
function _ajaxPage(e) {
    return window.ajax
        ? (jQuery(document).on("click",
            '.ajaxNav a[href!="#"], a.ajax[href!="#"]',
            function(e) {
                e.preventDefault(), window.location.hash = jQuery(this).attr("href"), document.title =
                    jQuery(this).attr("title") || jQuery(this).html().replace(/(<([^>]+)>)/gi, "")
            }), void (window.ajax === !0 &&
            e === !1 &&
...
function _loadPage(e, t) {
    if ("#" == e) return !1;
    if (!t) var t = "#middle";
    e = e.replace("#", ""), "" == e && (window.location.hash = "#dashboard.html", e = "dashboard.html"), e =
        "tpl/" + e, jQuery.ajax({
        url: e,
        dataType: "html",
        type: "GET",
        ...
        error: function() {
            jQuery(t).html(
                '<div class="text-center ajax-err"><h1 class="err404"><i class="fa fa-warning"></i>Page not found<small></small></h1></div>')
        }
    })
}
...
function _slimScroll() {
    jQuery(".slimscroll").each(function() {
        var e;
        e = jQuery(this).attr("data-height") ? jQuery(this).attr("data-height") : jQuery(this).height(), jQuery(this)
            .slimScroll({
            ...
            jQuery(this).bind("mousewheel DOMMouseScroll",
                function(e) {
                    var t = null;
                    "mousewheel" == e.type
                        ? t = -1 * e.originalEvent.wheelDelta
                        : "DOMMouseScroll" == e.type && (t = 40 * e.originalEvent.detail), t &&
                        (e.preventDefault(), jQuery(this).scrollTop(t + jQuery(this).scrollTop()))
                })
    })
}
...
function _popover() {
    jQuery("a[data-toggle=popover]").bind("click",
        function(e) {
    ...
    jQuery("a[data-toggle=popover], button[data-toggle=popover]").popover({
        ...
        $(this).popover("show"), $(".popover-title").append('<button type="button" class="close">&times;</button>'),
...
function _lightbox() {
    ...
    e.length > 0 &&
        loadScript(plugin_path + "magnific-popup/jquery.magnific-popup.min.js",
            function() {
                return "undefined" == typeof jQuery.magnificPopup
                    ? !1
                    : (jQuery.extend(!0,
                        jQuery.magnificPopup.defaults,
                        {
                            tClose: "Close",
                            tLoading: "Loading...",
                            gallery: {
...
function _toggle() {
    var e = 25;
    jQuery("div.toggle.active > p").addClass("preview-active"), jQuery("div.toggle.active > div.toggle-content")
        .slideDown(400), jQuery("div.toggle > label").click(function(t) {
        ...
        if (n && "undefined" != typeof t.originalEvent && r.find("div.toggle.active > label").trigger("click"),
            a.toggleClass("active"), a.find("> p").get(0)) {
            i = a.find("> p");
            var o = i.css("height"),
                l = i.css("height");
...
function _charts(e) {
    jQuery(".sparkline").length > 0 &&
        loadScript(plugin_path + "chart.sparkline/jquery.sparkline.min.js",
            function() {
                jQuery().sparkline &&
                (e === !0
            ...
            }), jQuery(".easyPieChart").length > 0 &&
        loadScript(plugin_path + "chart.easypiechart/jquery.easypiechart.min.js",
            function() {
                jQuery().easyPieChart &&
            ...
            }), jQuery("input.knob").length > 0 &&
        loadScript(plugin_path + "chart.knob/dist/jquery.knob.min.js",
            function() {
                jQuery().knob &&
...
function _autosuggest() {
    _container = jQuery("div.autosuggest"), _container.length > 0 &&
        loadScript(plugin_path + "typeahead.bundle.js",
            function() {
                jQuery().typeahead &&
...
function _form() {
    jQuery("form.validate-plugin").length > 0 &&
        loadScript(plugin_path + "form.validate/jquery.form.min.js",
            function() {
                        ...
                        jQuery().validate &&
                            jQuery("form.validate").each(function() {
                                var e = jQuery(this),
                                    ...
                                    a = (e.attr("data-captcha") || "Invalid Captcha!", e.attr("data-toastr-position") ||
                                        "top-right"),
                                    r = e.attr("data-toastr-type") || "success";
                                _Turl = e.attr("data-toastr-url") || !1, e.append(
                                    '<input type="hidden" name="is_ajax" value="true" />'), e.validate({
                                    submitHandler: function(e) {
                                        jQuery(e).find(".input-group-addon").find(".fa-envelope")
                                            .removeClass("fa-envelope")
                                            .addClass("fa-refresh fa-spin"), jQuery(e).ajaxSubmit({
                                            target: jQuery(e).find(".validate-result").length > 0
                                            ...
                                            success: function(i) {
                                                var i = i.trim();
                                                "_failed_" == i
                                                    ? _toastr("SMTP ERROR! Please, check your config file!",
                                                        a,
                                                        "error",
                                                        !1)
                                                    : "_captcha_" == i
                                                    ? _toastr("Invalid Captcha!", a, "error", !1)
                                                    : (jQuery(e).find(".input-group-addon").find(".fa-refresh")
    ...
    e.length > 0 &&
        loadScript(plugin_path + "form.masked/jquery.maskedinput.js",
            function() {
                e.each(function() {
                    var e = jQuery(this);
                    _format = e.attr("data-format") || "(999) 999-999999", _placeholder =
                        e.attr("data-placeholder") || "X", jQuery.mask.definitions.f = "[A-Fa-f0-9]", e.mask(_format,
                        {
...
function _select2() {
    ...
    e.length > 0 &&
        loadScript(plugin_path + "select2/js/select2.full.min.js",
            function() {
...
function _stepper() {
    ...
    e.length > 0 &&
        loadScript(plugin_path + "form.stepper/jquery.stepper.min.js",
            function() {
                jQuery().stepper &&
...
function _pickers() {
    ...
    e.length > 0 &&
        loadScript(plugin_path + "bootstrap.datepicker/js/bootstrap-datepicker.min.js",
            function() {
                jQuery().datepicker &&
                    e.each(function() {
                        var e = jQuery(this),
    ...
    t.length > 0 &&
        loadScript(plugin_path + "bootstrap.daterangepicker/moment.min.js",
            function() {
    ...
    a.length > 0 &&
        loadScript(plugin_path + "timepicki/timepicki.min.js",
            function() {
                jQuery().timepicki && a.timepicki()
            });
    var r = jQuery(".colorpicker");
    r.length > 0 &&
        loadScript(plugin_path + "spectrum/spectrum.min.js",
            function() {
                jQuery().spectrum &&
                    r.each(function() {
                        var e = jQuery(this),
                        ...
                        _color =
                                e.attr("data-defaultColor") ? e.attr("data-defaultColor") : "#ff0000",
                            e.attr("data-defaultColor") || "true" != i || (_color = null), e.spectrum({
...
function _editors() {
    ...
    e.length > 0 &&
        loadScript(plugin_path + "editor.summernote/summernote.min.js",
            function() {
                jQuery().summernote &&
                    e.each(function() {
                        var e = jQuery(this).attr("data-lang") || "en-US";
                        "en-US" != e &&
                                (alert(e), loadScript(plugin_path + "editor.summernote/lang/summernote-" + e + ".js")),
    ...
    t.length > 0 &&
        loadScript(plugin_path + "editor.markdown/js/bootstrap-markdown.min.js",
            function() {
                jQuery().markdown &&
                    t.each(function() {
                        var e = jQuery(this),
...
function _misc() {
    jQuery().masonry && jQuery(".masonry").masonry(), jQuery(".incr").bind("click",
        function(e) {
            e.preventDefault();
        ...
        }), jQuery("a.toggle-default").bind("click",
        function(e) {
            e.preventDefault();
            var t = jQuery(this).attr("href");
            jQuery(t).is(":hidden")
                ? (jQuery(t).slideToggle(200), jQuery("i.fa", this).removeClass("fa-plus-square")
                    .addClass("fa-minus-square"))
                : (jQuery(t).slideToggle(200), jQuery("i.fa", this).removeClass("fa-minus-square")
                    .addClass("fa-plus-square"))
        });
    var e = jQuery("input[type=file]");
    e.length > 0 && loadScript(plugin_path + "custom.fle_upload.js"), jQuery("textarea.word-count").on("keyup",
        function() {
            var e = jQuery(this),
...
function _goFullScreen() {
    jQuery("#goToFullScreen").unbind(), jQuery("#goToFullScreen").bind("click",
        function(e) {
            e.preventDefault(),
...
function _aside() {
    jQuery("#mobileMenuBtn").bind("click",
        function(e) {
            e.preventDefault(), jQuery(this).toggleClass("active"), window.width > 768
                ? jQuery("body").hasClass("min")
                ? (jQuery("body").removeClass("min"), jQuery("#sideNav>h3").show(), jQuery("#middle").css({
                    "margin-left": ""
                }))
                : (jQuery("#middle").css({
                        "margin-left": "0"
                    }), jQuery("body").addClass("min"),
                    jQuery("#aside nav li.el_primary.menu-open ul.sub-menu").prop("style") &&
                        jQuery("#aside nav li.el_primary.menu-open ul.sub-menu").prop("style")
                        .removeProperty("display"),
                    jQuery("#sideNav>h3").hide(), jQuery("#aside nav li.el_primary").removeClass("menu-open"))
                : jQuery("body").hasClass("menu-open")
                ? (jQuery("body").removeClass("menu-open"), jQuery("#sideNav>h3").show(), jQuery("#middle").css({
                    "margin-left": ""
                }))
                : (jQuery("#middle").css({
                        "margin-left": "0"
...
function _panels() {
    jQuery("#middle div.panel ul.options>li>a.panel_colapse").bind("click",
        function(e) {
            e.preventDefault();
            var t = jQuery(this).closest("div.panel"),
                ...
                n = t.attr("id");
            i.slideToggle(200), r.slideToggle(200,
                function() {
                    r.is(":hidden")
                        ? "" != n && void 0 != n && localStorage.setItem(n, "hidden")
        ...
        "hidden" == i && (t.slideToggle(0), a.slideToggle(0), n.toggleClass("plus").toggleClass("")), "removed" == i &&
            jQuery("#" + r).remove()
    }), jQuery("#middle div.panel ul.options>li>a.panel_close").bind("click",
        function(e) {
            e.preventDefault();
            var t = jQuery(this).closest("div.panel"),
                a = t.attr("id");
            jQuery(t).fadeOut(300,
                function() {
                    jQuery(this).remove(), "function" == typeof _closePanel && _closePanel(a)
                })
        }), jQuery("#middle div.panel ul.options>li>a.panel_fullscreen").bind("click",
        function(e) {
            e.preventDefault();
            var t = jQuery(this).closest("div.panel"),
                a = jQuery("a.panel_close", t).closest("li");
            panel_colapse =
                    jQuery("a.panel_colapse", t).closest("li"), t.toggleClass("fullscreen").toggleClass(""),
                a.toggleClass("hide").toggleClass(""), panel_colapse.toggleClass("hide").toggleClass(""),
        ...
        if (e = e || window.event, 27 == e.keyCode) {
            ...
            t.length > 0 &&
            (panel_close = jQuery("a.panel_close", t).closest("li"), panel_colapse =
                    jQuery("a.panel_colapse", t).closest("li"), panel_close.removeClass("hide"),
                panel_colapse.removeClass("hide"), t.removeClass("fullscreen"))
        }
    }
}
...
function _modalAutoLoad() {
    jQuery("div.modal").length > 0 &&
        jQuery("div.modal").each(function() {
            ...
            "" != t && "hidden" == localStorage.getItem(t) && (a = "false"), "true" == a &&
                jQuery(window).load(function() {
                    ...
                    setTimeout(function() {
                        ...
                        parseInt(t))
                }), jQuery("input.loadModalHide", this).bind("click",
                function() {
                    var e = jQuery(this);
                    e.is(":checked")
...
function disable_scroll() {
    window.addEventListener && window.addEventListener("DOMMouseScroll", wheel, !1), window.onmousewheel =
        document.onmousewheel = wheel
}

function enable_scroll() {
    window.removeEventListener && window.removeEventListener("DOMMouseScroll", wheel, !1), window.onmousewheel =
        document.onmousewheel = document.onkeydown = null
}
...
window.width = jQuery(window).width(), jQuery(window).ready(function() {
    loadScript(plugin_path + "bootstrap/js/bootstrap.min.js",
        function() {
            FirstInit()
        })
});
...
! function(e) {
            ...
            browserDetect: function() {
                var e = navigator.userAgent,
                    ...
                    s = [
                        ...
                        ? i + " iron"
                        : a("applewebkit/")
                        ? i + " " + n + (/version\/(\d+)/.test(t) ? " " + n + RegExp.jQuery1 : "")
                        : a("mozilla/")
                        ? r
                        : "",
                        a("j2me")
    ...
    function(e, t, a) {
        ...
        function n() {
            ...
            (a.data("password")
                ? (t =
                    a.next().show().focus(), e("label[for=" + a.attr("id") + "]").attr("for", t.attr("id")), a.remove())
                : a.realVal() == a.attr("placeholder") && (a.val(""), a.removeClass("placeholder")))
        }

        function o() {
            var t, a, r = e(this);
            placeholder = r.attr("placeholder"), e.trim(r.val()).length > 0 ||
            (r.is(":password")
                ? (a = r.attr("id") + "-clone", t = e("<input/>").attr(e.extend(i(this),
                    {
                        type: "text",
                        value: placeholder,
                        "data-password": 1,
                        id: a
                    })).addClass("placeholder"), r.before(t).hide(), e("label[for=" + r.attr("id") + "]").attr("for", a)
                )
                : (r.val(placeholder), r.addClass("placeholder")))
        }
        ...
        e.placeholder = {
            ...
            : (!a && l && !s && (u = "textarea[placeholder]"), e.fn.realVal = e.fn.val, e.fn.val = function() {
                var t, a = e(this);
                return arguments.length > 0
                    ? a.realVal.apply(this, arguments)
                    : (t = a.realVal(), a = a.attr("placeholder"), t == a ? "" : t)
            }, e.fn.placeholder = function() {
    ...
    }(jQuery, document, window.debug), jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing,
        {
            ...
            easeInOutExpo: function(e, t, a, r, i) {
                return 0 == t
                    ...
                    ? a + r
                    : (t /= i / 2) < 1
                    ? r / 2 * Math.pow(2, 10 * (t - 1)) + a
                    : r / 2 * (-Math.pow(2, -10 * --t) + 2) + a
            },
            ...
            easeInOutCirc: function(e, t, a, r, i) {
                return (t /= i / 2) < 1
                    ? -r / 2 * (Math.sqrt(1 - t * t) - 1) + a
                    : r / 2 * (Math.sqrt(1 - (t -= 2) * t) + 1) + a
            },
            ...
            easeInOutElastic: function(e, t, a, r, i) {
                ...
                return 1 > t
                    ? -.5 * l * Math.pow(2, 10 * (t -= 1)) * Math.sin(2 * (t * i - n) * Math.PI / o) + a
                    : l * Math.pow(2, -10 * (t -= 1)) * Math.sin(2 * (t * i - n) * Math.PI / o) * .5 + r + a
            },
            ...
            easeInOutBack: function(e, t, a, r, i, n) {
                return void 0 == n && (n = 1.70158), (t /= i / 2) < 1
                    ? r / 2 * t * t * (((n *= 1.525) + 1) * t - n) + a
                    : r / 2 * ((t -= 2) * t * (((n *= 1.525) + 1) * t + n) + 2) + a
            },
            ...
            easeOutBounce: function(e, t, a, r, i) {
                return (t /= i) < 1 / 2.75
                    ? 7.5625 * r * t * t + a
                    : 2 / 2.75 > t
                    ? r * (7.5625 * (t -= 1.5 / 2.75) * t + .75) + a
                    : 2.5 / 2.75 > t
                    ? r * (7.5625 * (t -= 2.25 / 2.75) * t + .9375) + a
                    : r * (7.5625 * (t -= 2.625 / 2.75) * t + .984375) + a
            },
            easeInOutBounce: function(e, t, a, r, i) {
                return i / 2 > t
                    ? .5 * jQuery.easing.easeInBounce(e, 2 * t, 0, r, i) + a
                    : .5 * jQuery.easing.easeOutBounce(e, 2 * t - i, 0, r, i) + .5 * r + a
            }
        }),
    function(e) {
        e.fn.extend({
            slimScroll: function(a) {
                ...
                return this.each(function() {
                    function i(t) {
                        if (c) {
                            ...
                            t.wheelDelta && (a = -t.wheelDelta / 120), t.detail && (a = t.detail / 3),
                                e(t.target || t.srcTarget || t.srcElement).closest("." + r.wrapperClass)
                                    .is(j.parent()) &&
                                    n(a, !0), t.preventDefault && !v && t.preventDefault(), v || (t.returnValue = !1)
                        }
                    }
                    ...
                    function n(e, t, a) {
                        ...
                        t &&
                        (i = parseInt(w.css("top")) + e * parseInt(r.wheelStep) / 100 * w.outerHeight(), i =
                            Math.min(Math.max(i, 0), n), i = e > 0 ? Math.ceil(i) : Math.floor(i), w.css({
                            top: i + "px"
                        })), y = parseInt(w.css("top")) / (j.outerHeight() - w.outerHeight()), i =
                            y * (j[0].scrollHeight - j.outerHeight()), a &&
                        (i = e, e = i / j[0].scrollHeight * j.outerHeight(), e = Math.min(Math.max(e, 0), n), w.css({
                            top: e + "px"
                    ...
                    function o() {
                        window.addEventListener
                            ? (this.addEventListener("DOMMouseScroll", i, !1), this.addEventListener("mousewheel",
                                i,
                                !1))
                    ...
                    function s() {
                        l(), clearTimeout(h), y == ~~y
                            ? (v = r.allowPageScroll, g != y && j.trigger("slimscroll", 0 == ~~y ? "top" : "bottom"))
                            : v = !1, g =
                            y, m >= j.outerHeight()
                            ? v = !0
                            : (w.stop(!0, !0).fadeIn("fast"), r.railVisible && b.stop(!0, !0).fadeIn("fast"))
                    }
                    ...
                    if (j.parent().hasClass(r.wrapperClass)) {
                        ...
                        r.height = "auto" == r.height ? j.parent().height() : r.height, Q = e("<div></div>")
                            .addClass(r.wrapperClass).css({
                                position: "relative",
                                overflow: "hidden",
                                width: r.width,
                                height: r.height
                        ...
                        b.css(_), w.css(_), j.wrap(Q), j.parent().append(w), j.parent().append(b), r.railDraggable &&
                            w.bind("mousedown",
                                function(a) {
                                    var r = e(document);
                                    return p = !0, t = parseFloat(w.css("top")), pageY = a.pageY, r.bind(
                                        "mousemove.slimscroll",
                                        function(e) {
                                            currTop = t + e.pageY - pageY, w.css("top", currTop), n(0,
                                                w.position().top,
                                                !1)
                            ...
                            function(e) {
                                v || e.originalEvent.preventDefault(), e.originalEvent.touches.length &&
                                (n((f - e.originalEvent.touches[0].pageY) / r.touchScrollStep, !0), f =
                            ...
                            : "top" !== r.start &&
                            (n(e(r.start).position().top, null, !0), r.alwaysVisible || w.hide()), o()
                    }
                }), this
            }
        }), e.fn.extend({
