...
function _music() {
    ...
    /** AUDIO PLAYER
     ** *********************** **/
    loadScript(plugin_path + 'mediaelement/mediaelement-and-player.min.js',
        function() { // load mediaelement plugin first!
            ...
            function _playlist() {
                jQuery(".music-player-list>li").click(function() {
                    ...
                    var top_player = jQuery(this).parent('.music-player-list')
                        .siblings('.music-top-player, .music-float-top-player');
            ...
            jQuery('.music-play-album').click(function() {
                ...
                if (jQuery(this).siblings('.music-album-thumbnail').html()) {
                    float_player.find('.music-top-player-thumbnail')
                        .html(jQuery(this).siblings('.music-album-thumbnail').html());
                }
            ...
            jQuery("#music-player .mejs-playpause-button").bind("click",
                function(e) {
                    e.preventDefault();
            ...
            jQuery("#music-player-open").bind("click",
                function(e) {
                    e.preventDefault();
            ...
            jQuery("#music-player-close").bind("click",
                function(e) {
                    e.preventDefault();
