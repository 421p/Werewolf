    ...
    **/
    if (jQuery(".fullwidthbanner").length > 0) {
        ...
        revapi = jQuery('.fullwidthbanner').revolution({
            ...
            navigationStyle:
                jQuery('.fullwidthbanner').attr('data-navigationStyle') ||
                    "round", // round,square,navbar,round-old,square-old,navbar-old (see docu - choose between 50+ different item)
        ...
        tpj(document).ready(function() {
            ...
            if (tpj('.fullscreenbanner').revolution != undefined) {
                revapi25 = tpj('.fullscreenbanner').show().revolution({
                    ...
                    hideAllCaptionAtLilmit: 0,
                    startWithSlide: 0,
                    fullScreenOffsetContainer: jQuery("#header").hasClass('transparent') ||
