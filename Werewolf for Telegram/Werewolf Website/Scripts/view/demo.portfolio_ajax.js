...
function _portfolioAjaxOpen() {
    ...
    jQuery("a.portfolio-ajax-page").bind("click",
        function(e) {
            e.preventDefault();
            ...
            if (_href != '' && _href != "#") {
                ...
                if (jQuery("#portfolio_ajax_container").is(":visible")) {
                    jQuery("#portfolio_ajax_container")
                        .append(
                            '<span class="overlay light-4"><span><i class="fa fa-refresh fa-spin"></i><span></span>');
                }
                ...
                jQuery.ajax({
                    ...
                    success: function(data) {
                        jQuery('html,body').stop()
                            .animate({ scrollTop: jQuery("#portfolio_ajax_container").offset().top - 120 },
                                800,
                                'easeInOutExpo');
                        ...
                        jQuery("#portfolio_ajax_container").slideDown(500,
                            function() {
...
function _portfolioAjaxClose() {
    jQuery("a.portfolio-ajax-close").bind("click",
        function(e) {
            e.preventDefault();
