...
namespace Database
{
    ...
    public enum Achievements : long
    {
        ...
        [Display(Name = "Inconspicuous"),
         Description("In a game of 20 or more people, do not get a single lynch vote against you (and survive)")]
        ...
        [Display(Name = "Streetwise"),
         Description("Find a different wolf, serial killer, or cultist 4 nights in a row as the detective")]
        ...
        [Display(Name = "Even a Stopped Clock is Right Twice a Day"),
        ...
        [Display(Name = "Saved by the Bull(et)"),
         Description(
