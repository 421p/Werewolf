...
namespace Werewolf_Control.Helpers
{
 ...
 new List<string> { "BQADBAAD8hUAAhYYZAeHmbRRzioXXQI", "BQADBAADYAMAAkMdZAfR4qo8c95FGgI" };
        ...
        {
            "BQADAwADggADdBexB2aZTAMpXRGUAg",
            "BQADBAADKgMAAoMbZAfmSqOE1YY-9wI",
            "BQADBAADWAMAAt4cZAe6rGbV3KvLggI"
        };

        public static List<string> WolfWin =
            new List<string> {"BQADAwADgAADdBexB015e-EU6O9CAg", "BQADAwADgQADdBexB9ksBD5NOWQvAg"};

        public static List<string> WolvesWin =
            new List<string> {"BQADBAADlwMAAtgaZAfCK5MVLj27CwI", "BQADBAADcAMAAn8ZZAe0Xjey6zCmQwI"};

        public static List<string> VillagersWin = new List<string> {"BQADAwADgwADdBexB2K0cDWari8QAg"};

        public static List<string> NoWinner =
            new List<string> {"BQADBAAD8QgAAqIeZAeufUVx9eT3SgI", "BQADBAADuAMAAlUXZAfNGmq-KVN_0AI"};

        public static List<string> StartGame =
            new List<string> {"BQADAwADhAADdBexB3lX1nJOQOdEAg", "BQADBAADwg0AAu0XZAcUNBLuEjnBhgI"};

        public static List<string> StartChaosGame =
            new List<string> {"BQADBAAD7wYAAgcYZAei_MiVQcRUIAI", "BQADBAAD_wcAAiUYZAeV5N-hkeMW0QI"};

        public static List<string> TannerWin =
            new List<string> {"BQADBAADQwgAAuQaZAcWZKq6Zm4NJAI", "BQADBAAD_gMAAtgaZAeJOVus4yf3RAI"};

        public static List<string> CultWins =
            new List<string> {"BQADBAADWAMAAosYZAf5H-sYZ53nMwI", "BQADBAADHwsAAgUYZAeDkYYi5N3cIgI"};

        public static List<string> SerialKillerWins = new List<string>
        {
            "BQADBAADKwMAAsQZZAf4t254zcOVdgI",
            "BQADBAADOAQAAqUXZAdnNEO6TaxtnQI",
            "BQADBAADdQMAAsEcZAfkYMOxn9xzBAI",
            "BQADBAADmgMAArgcZAfW46sJoTg9VQI"
        };
