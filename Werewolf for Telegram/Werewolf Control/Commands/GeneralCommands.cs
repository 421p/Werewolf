...
namespace Werewolf_Control
{
    public static partial class Commands
    {
        ...
        [Attributes.Command(Trigger = "getstatus")]
        ...
        [Attributes.Command(Trigger = "version")]
        ...
        public static void SetLang(Update update, string[] args)
        {
            ...
            Bot.Api.SendTextMessageAsync(update.Message.From.Id,
                GetLocaleString("WhatLang", curLangFileName, curLang.Base),
                replyMarkup: menu);
        ...
        public static void GetLang(Update update, string[] args)
        {
            ...
            List<InlineKeyboardCallbackButton> buttons = langs.Select(x => x.Base).Distinct().OrderBy(x => x)
                ...
                .ToList();
            buttons.Insert(0,
                new InlineKeyboardCallbackButton("All", $"getlang|{update.Message.From.Id}|All|null|base"));
            ...
            {
                Bot.Api.SendTextMessageAsync(update.Message.Chat.Id,
                    GetLocaleString("GetLang", GetLanguage(update.Message.Chat.Id)),
        ...
        public static void GetStats(Update u, string[] args)
        {
            ...
            else
            {
                ...
                buttons.Add(new[]
                {
                    new InlineKeyboardUrlButton($"{u.Message.From.FirstName} Stats",
                        "http://www.tgwerewolf.com/Stats/Player/" + u.Message.From.Id + "?referrer=stats")
                });
                var menu = new InlineKeyboardMarkup(buttons.ToArray());
                Bot.Api.SendTextMessageAsync(u.Message.Chat.Id, "Stats", replyMarkup: menu);
            }
