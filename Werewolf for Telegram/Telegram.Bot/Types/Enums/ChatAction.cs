...
namespace Telegram.Bot.Types.Enums
{
    ...
    public enum ChatAction
    {
        ...
        [EnumMember(Value = "upload_photo")] UploadPhoto,

        [EnumMember(Value = "record_video")] RecordVideo,

        [EnumMember(Value = "upload_video")] UploadVideo,

        [EnumMember(Value = "record_audio")] RecordAudio,

        [EnumMember(Value = "upload_audio")] UploadAudio,

        [EnumMember(Value = "upload_document")]
        UploadDocument,

        [EnumMember(Value = "find_location")] FindLocation,
    }
